...
lib.ssMetadata = [
		{name:"1280x100_atlas_1", frames: [[0,0,1280,100],[0,102,1280,100],[0,204,1280,100],[0,306,1280,100],[0,408,1280,100]]}
];
...
(lib.CTSBig3_0001s_0002_8locationsandnowopeninHammondIN = function() {
	this.initialize(ss["1280x100_atlas_1"]);
	this.gotoAndStop(2);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.CTSBig3_0001s_0002_8locationsandnowopeninHammondIN();
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(456,75,0.1111,0.1111,0,0,0,482.9,63);
	...
	this.shape.setTransform(90.55,50.05);
...
p.nominalBounds = new cjs.Rectangle(599.1,26,753.4,84.1);
// library properties:
lib.properties = {
